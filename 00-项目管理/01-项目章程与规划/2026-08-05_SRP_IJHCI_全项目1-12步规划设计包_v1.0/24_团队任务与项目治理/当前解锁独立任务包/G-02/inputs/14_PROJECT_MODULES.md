...
- Unity现有资产和场景只作迁移参考；V-01研究体验契约与完整旅程已由真实团队第二人签收并转为`DONE`，不代表Unity运行完成；V-02已完成四天气场景与呼吸提示设计核对并准备候选验收，F-05独立承担`storm`双停与`fade`双吸的相位实例v2.2及消费者迁移，V-03至V-05继续负责四层映射合同与工程风险排序、分镜声音预演和全旅程灰盒，目标四层接口、双条件和完整会话状态机仍未实现；
