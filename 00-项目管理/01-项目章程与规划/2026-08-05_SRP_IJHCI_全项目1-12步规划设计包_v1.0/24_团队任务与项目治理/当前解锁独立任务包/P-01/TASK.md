...
- [x] AC1确定性时钟与24种顺序两种提示模式测试通过
- [x] AC2重复请求不推进且控制重试保持同ID同序号
- [x] AC3非法转换正式失败关闭与四模块800秒回放通过
...
- 证据路径：`02-技术研发/05-通信协议/F-01_技术验收记录.md`；`02-技术研发/srp_session_core/P-01_技术验收记录.md`；`02-技术研发/srp_session_core/fixtures/golden/four-module-trace-v1.json`
- commit：`03d7426219121e49554e405db9dd521b8ab1d819`
- push目标：`origin/codex/p-01-session-core`
