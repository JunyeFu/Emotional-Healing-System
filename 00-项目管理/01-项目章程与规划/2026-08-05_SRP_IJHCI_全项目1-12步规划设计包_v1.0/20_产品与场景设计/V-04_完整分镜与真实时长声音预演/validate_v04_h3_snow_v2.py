...
def main() -> None:
    ...
    require(manifest["preview_id"] == "snow-candidate-v2" and manifest["technical_id"] == "snow", "manifest identity drift")
    ...
    print(
        "PASS: V-04 snow-candidate-v2 machine gate; 10s 5-5 dual-condition media, "
        "mirrored powder motion, equal phase intensity, divergent actual, shared fixed camera, environment and audio verified; human review pending"
    )
