...
def main() -> None:
    ...
    require(manifest["preview_id"] == "storm-candidate-v2" and manifest["technical_id"] == "storm", "manifest identity drift")
    ...
    print(
        "PASS: V-04 storm-candidate-v2 machine gate; 12s four-phase dual-condition media, "
        "stable holds, divergent actual, shared fixed camera, environment and audio verified; human review pending"
    )
