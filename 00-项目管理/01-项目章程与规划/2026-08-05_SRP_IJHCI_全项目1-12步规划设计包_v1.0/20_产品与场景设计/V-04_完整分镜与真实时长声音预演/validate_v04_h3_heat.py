...
def main() -> None:
    ...
    require(manifest["preview_id"] == "heat-candidate-v1" and manifest["technical_id"] == "heat", "manifest identity drift")
    ...
    print(
        "PASS: V-04 heat-candidate-v1 machine gate; 10s 4-6 dual-condition media, "
        "longer exhale path, divergent actual, shared environment, scroll and audio verified"
    )
