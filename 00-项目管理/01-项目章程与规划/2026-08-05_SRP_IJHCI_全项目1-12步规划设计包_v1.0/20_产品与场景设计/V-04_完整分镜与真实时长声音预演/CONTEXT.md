...
| 当前状态 | `V-04_实施状态与H1确认记录_v2.3.md` |
| 四天气固定镜头修订 | `V-04_H3_四天气固定镜头修订合同_v1.0.md` |
| R2大景深事件构图 | `V-04_H3_四天气大景深事件构图合同_v1.0.md` |
| R2独立背景预览 | `V-04_H3_R2大景深AAA背景生图提示词_v1.0.md`、`V-04_H3_R2大景深背景预览候选清单_v1.0.json`、`V-04_H3_R2大景深背景预览验证记录_v1.0.md`、`validate_v04_h3_r2_previews.py` |
...
| H3固定背景选择 | `PENDING` | R2三组十二张独立大景深预览已生成；待逐天气选择A/B/C，V-04继续`IN_PROGRESS` |
...
旧H3合并机器门和独立复审结果作为历史证据保留。下一硬门为`H3_FIXED_BACKGROUND_PREVIEW_SELECTION`；R2候选清单提供推荐组合`storm=B, heat=C, snow=C, fade=C`，但只有团队总监选择才会冻结方向。选择前，V-04继续保持`IN_PROGRESS`且不解锁V-05。
