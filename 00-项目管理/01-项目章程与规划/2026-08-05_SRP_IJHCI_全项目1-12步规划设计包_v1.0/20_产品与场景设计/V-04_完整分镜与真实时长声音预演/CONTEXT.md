...
| 可拆层背景重建候选 | `V-04_H3_可拆层背景重建合同_v1.0.md`、`V-04_H3_可拆层背景重建候选清单_v1.0.json`、`V-04_H3_fade_v4真实感重建提示词_v1.0.md`、`validate_v04_h3_layerable_background_rebuild.py` |
...
旧H3合并机器门和独立复审结果作为历史证据保留。团队总监已选择`storm=B, heat=C, snow=C, fade=C`。`H3_LAYERABLE_BACKGROUND_REBUILD`已有四张构图基准图与分层合同，待团队总监确认后导出实际透明分层文件；此前V-04继续保持`IN_PROGRESS`且不解锁V-05。
