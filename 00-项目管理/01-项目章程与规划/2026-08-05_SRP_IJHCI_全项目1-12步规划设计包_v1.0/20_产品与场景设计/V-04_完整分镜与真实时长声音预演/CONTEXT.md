...
| H3三天气固定底片人工结论 | `V-04_H3_三天气固定底片人工评审记录_v1.0.json`、`V-04_H3_三天气固定底片人工评审结论_v1.0.md` |
...
| H3 storm固定输入 | `PASS_HUMAN` | candidate-v2的机器门与团队总监人工评审均通过 |
| H3 heat固定输入 | `PASS_HUMAN` | candidate-v2的机器门与团队总监人工评审均通过 |
| H3 snow固定输入 | `PASS_HUMAN` | candidate-v2的机器门与团队总监人工评审均通过 |
...
| H3独立贴纸素材 | `STORM_HEAT_AND_SNOW_READY_FOR_TEAM_DIRECTOR_REVIEW` | storm、heat与snow各八项独立RGBA素材及派生评审图已通过机器检查；fade尚未生成 |
...
storm、heat和snow固定镜头v2媒体分别位于`.artifacts-local/V-04/H3/<weather>-candidate-v2/`。三项专项机器门和团队总监十二项人工评审均为`PASS`。
...
由团队总监确认storm、heat与snow各八项独立素材的画风、职责、透明边缘和自由组合可用性，再生成fade。四天气独立素材全部通过后进入`H3_FIXED_COMBINED_REVIEW`；此前V-04继续保持`IN_PROGRESS`且不解锁V-05。
