...
| 当前状态 | `V-04_实施状态与H1确认记录_v2.2.md` |
| 四天气固定镜头修订 | `V-04_H3_四天气固定镜头修订合同_v1.0.md` |
| 固定镜头背景预览 | `V-04_H3_固定镜头高精度背景生图提示词_v1.0.md`、`V-04_H3_固定镜头背景预览候选清单_v1.0.json` |
...
| H3固定背景选择 | `PENDING` | 待从A/B/C三组中为四天气选择方向；V-04继续`IN_PROGRESS` |
...
旧H3合并机器门和独立复审结果作为历史证据保留。下一硬门为`H3_FIXED_BACKGROUND_PREVIEW_SELECTION`；团队总监完成四天气背景方向选择前，V-04继续保持`IN_PROGRESS`且不解锁V-05。
