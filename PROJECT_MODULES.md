...
- Unity现有资产和场景只作迁移参考；V-01与V-02已由真实团队第二人签收并转为`DONE`，不代表Unity运行完成；V-02签收对象为提交`3ebbdee`，签收提交为`c04a7be`；V-03现为`READY`，负责四层映射合同与工程风险排序；F-05独立承担`storm`双停与`fade`双吸的相位实例v2.2及消费者迁移，V-04至V-05后续负责分镜声音预演和全旅程灰盒，目标四层接口、双条件和完整会话状态机仍未实现；
