...
> 本文件是新实现的模块、接口、依赖和验证入口。研究与统计规则以 `00-项目管理/01-项目章程与规划/2026-08-05_SRP_IJHCI_全项目1-12步规划设计包_v1.0/00_总控/11_实现冻结基线_v1.0.md` 为准。旧UDP v1.2、四维合成评分、TD呼吸圈和Spout链均为迁移输入，不是目标运行架构。
...
| M01 | 体验与测量设计 | `01-需求与设计/`、规划包`20_` | 四种映射语法、提示公平、SCCI与材料 | 设备驱动、运行编排 |
...
| V2 | 记录重放、故障注入、Unity无TD运行、30分钟真机稳定性 | Level C候选构建 |
