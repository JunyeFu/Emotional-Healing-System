...
- Unity现有资产和场景只作迁移参考；V-01与V-02已由真实团队第二人签收并转为`DONE`，不代表Unity运行完成；V-02签收对象为提交`3ebbdee`，签收提交为`c04a7be`；V-03已由Codex在`codex/v-03-visual-mapping`领取并转为`IN_PROGRESS`，前期规划已对齐至详细填充门，四天气详细映射、参数和风险评分尚未填写；F-05现为`READY`，独立承担`storm`双停与`fade`双吸的相位实例v2.2及消费者迁移；V-04至V-05后续负责分镜声音预演和全旅程灰盒，目标四层接口、两条件和完整会话状态机仍未实现；
